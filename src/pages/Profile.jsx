                    ...
                    <div className="border-b border-gray-200">
                        <nav className="-mb-px flex">
                            ...
                            <button
                                ...
                                className={`px-6 py-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'positions'
                                        ? 'border-blue-500 text-blue-600'
                                        : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                    }`}
                            >
                                    ...
                                    {activePositions.map((position) => (
                                        <div key={position.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-sm transition-shadow">
                                            <div className="flex justify-between items-start mb-3">
                                                ...
                                                <div className={`px-2 py-1 rounded text-xs font-medium ${position.position === 'YES'
                                            ...
                                            <div className="grid grid-cols-4 gap-4 text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <div className={`font-medium ${position.pnl.startsWith('+') ? 'text-emerald-600' : 'text-red-600'
                                                        }`}>
                                                        {position.pnl}
                                                    </div>
                                                </div>
                                    ...
                                    {tradingHistory.map((trade) => (
                                        <div key={trade.id} className="border border-gray-200 rounded-lg p-4">
                                            <div className="flex justify-between items-start mb-3">
                                                ...
                                                <div className="text-right">
                                                    <div className={`px-2 py-1 rounded text-xs font-medium mb-1 ${trade.result === 'Won'
                                                            ? 'bg-emerald-100 text-emerald-700'
                                                            : 'bg-red-100 text-red-700'
                                                        }`}>
                                                        {trade.result}
                                            ...
                                            <div className="grid grid-cols-3 gap-4 text-sm">
                                                ...
                                                <div>
                                                    <div className="text-gray-500">P&amp;L</div>
                                                    <div className={`font-medium ${trade.pnl.startsWith('+') ? 'text-emerald-600' : 'text-red-600'
                                                        }`}>
                                                        {trade.pnl}
                                                    </div>
                                                </div>
